...
<html lang="en-IN" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Online Compiler - CyberHawk</title>
  ...
  <body onload="ready()" style="background:#1B1B1D;" >
  <div style="-webkit-transform: translate(-50%,-50%);
        transform: translate(-50%,-50%);
        position: absolute;
        top: 50%;
        left: 50%;">
    <img src="https://cdn.dribbble.com/users/369184/screenshots/4126263/loading-done.gif"
        onload="displayImage(this)" style="height: 400px;">
    </div>
